...
export default function AudioTest() {
  ...
  // Create audio context and position audio in left/right channels when playing
  ...
  return (
    <div className="container mx-auto py-10 px-4">
      ...
      <p className="mb-6">Test your left and right speakers to ensure they're working correctly.</p>
      ...
      <div className="flex flex-col md:flex-row gap-6 mb-8">
        <button 
          ...
          className={`py-4 px-8 rounded-lg text-lg font-medium ${
            activeChannel === "left" 
